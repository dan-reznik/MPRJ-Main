...
* Aula 3
    + Atualizar o fork do projeto
        + `git remote add upstream https://github.com/dan-reznik/MP-Execucao-Orcamentaria`
        + `git fetch upstream`
        + `git checkout master`
        + `git merge upstream/master`
        + "push" p/ seu fork com o `git` do Rstudio
    + Introdução ao "pipe" `%>%`
    + Os 5 verbos do `dplyr`: select, filter, group_by, summarize, arrange
    + Exercícios
* Aula 4
...
* [Execução Orçamentária](https://dan-reznik.github.io/MP-Execucao-Orcamentaria)
